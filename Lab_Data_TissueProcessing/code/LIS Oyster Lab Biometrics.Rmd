...
Updated 11/19/24 by K. Lenderman
...
data_all<- data_all %>%
 mutate(condition_score = recode(condition, "1_very_good" = 1, "2_good" = 2, "3_good_minus"= 3, "4_fair_plus"= 4, "5_fair"= 5,"6_fair_minus"= 6,"7_poor_plus"=7, "8_poor"= 8, "9_very_poor"= 9))
head(data_all)
...
ASHC_BCS_percentage <- ggplot(ASHC_precent_greater_3,aes(x = month, y = Percentage)) +
...
df_GOLD<- data_all%>%
  filter(site=="GOLD")
df_GOLD <- df_GOLD %>% filter(!is.na(condition))
