...
Updated 12/11/24 by K. Lenderman
...
data_all<- data_all %>%
 dplyr::mutate(condition_score = recode(as.character(condition), "1_very_good" == 1, "2_good" == 2, "3_good_minus"== 3, "4_fair_plus"== 4, "5_fair"== 5,"6_fair_minus"== 6,"7_poor_plus"== 7,"8_poor" == 8, "9_very_poor" == 9))
head(data_all)


data_all <- data_all %>%
  dplyr::mutate(condition_score = dplyr::case_when(
...
df_bcs_proportions_new <- rbind(df_BCS_proportions2023, df_BCS_proportions2024)
...
FENC_precent_greater_3 <- df_FENC.2024 %>%
