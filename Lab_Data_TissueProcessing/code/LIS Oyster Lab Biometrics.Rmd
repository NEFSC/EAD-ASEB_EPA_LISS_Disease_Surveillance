...
Updated 12/12/2025 by K.Lenderman
 - data check
 - Updated notes for 1025GOLD, 1125GOLD, and 1225GOLD collections
...
#nitr::opts_knit$set(root.dir = 'C:/Users/mariah.kachmar/documents/Github/EAD-ASEB_EPA_LISS_Disease_Surveillance') #Mariah's
...
FENC_BCS_percentage <- ggplot(FENC_percent_greater_3,aes(x = month, y = Percentage)) +
  #geom_bar(width = 0.5, stat = "identity", position = "fill") +
    geom_col()+
  theme_bw() +
  theme(
