...
# 3. Generate the faceted plot (using a unique plot variable name)
...
#pdf("Field_Data_Biological/Output/Spring_Survey_Live_Shell_Height(2026).pdf", height = 6, width = 11)
#dev.off()
...
# 1. Data Wrangling & Distribution Calculation per Site
...
# 2. Generate the Corrected Plot Layout
...
#pdf(paste0(path = "Field_Data_Biological/Output/CT_Spring_Survey_2026_population_percentages.pdf"), height = 6, width = 11)
#dev.off()
```
...
#pdf("Field_Data_Biological/Output/Fall_Survey_Live_Shell_Height(2025).pdf", height = 6, width = 11)
#dev.off()
...
#pdf(paste0(path = "Field_Data_Biological/Output/CT_Fall_Survey_2025_population_percentages.pdf"), height = 6, width = 11)
#dev.off()
...
df_shellheight_proportions2026 <- height_ASHC_Live %>% 
  dplyr::filter(Year == "2026") %>% 
  filter(!is.na(Height)) %>% # Fix 1: Drop NAs early, ONLY for Height
  mutate(
    size_class = as.numeric(Height), 
    size_class_bin = cut(
      size_class, 
