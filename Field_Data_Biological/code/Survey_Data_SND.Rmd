...
FENC_Distribution_Live<- height_FENC_Live %>% 
  ...
  theme_bw() +  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())+ 
  #theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+
  labs(title="Fence Creek Live Oysters ", x ="Shell Height (mm)")+ scale_x_continuous(limits= c(0,200), breaks = seq(0,200, by =10) )+
...
ggplot(height_GOLD, aes(x = factor(Season, levels = c("Fall")), y = Height, fill = Season)) +
  geom_boxplot() +  
  theme_bw() +  
