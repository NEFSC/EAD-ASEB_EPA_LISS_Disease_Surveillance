...
ggplot(height_ASHC, aes(x=factor(Season, levels = c("Spring", "Fall")), y=Height, fill=Season)) +
  geom_boxplot()+  
   theme_bw() +  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())+ 
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))+
  labs(title="AshCreek", x ="Season", y = "Shell Height (mm)")+ theme(axis.title.y = element_text(size = rel(1.3), angle =90), axis.title.x = element_text(size = rel(1.3), angle = 0))+
...
ggplot(height_FENC, aes(x=factor(Season, levels = c("Spring", "Fall")), y=Height, fill=Season)) +
  geom_boxplot()+  
   theme_bw() +  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())+ 
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))+
  labs(title="Fence Creek", x ="Season", y = "Shell Height (mm)")+ theme(axis.title.y =
