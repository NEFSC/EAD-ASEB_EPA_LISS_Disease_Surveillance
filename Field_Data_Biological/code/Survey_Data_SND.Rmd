...
FENC_Distribution_Live<- height_FENC_Live %>% 
 ...
 facet_wrap (~ Year, scales = "fixed", nrow=3, strip.position = "right") + # Moves labels to the left side
  theme(strip.placement = "outside")  
FENC_Distribution_Live
#pdf(paste0(path = "Field_Data_Biological/Output/FENC_Spring_Distribution_Live.pdf"), height = 6, width = 15)
...
#pdf(paste0(path = "Field_Data_Biological/Output/FENC_Spring_Distribution_Dead.pdf"), height = 6, width = 15)
