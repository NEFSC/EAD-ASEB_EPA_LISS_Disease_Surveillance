...
write.csv(Master_2024_output, "output/Sonde Master Files/Sonde_master_2024.csv")
```

```{r}
#Parsing out specific sonde data using dates

#Juvenile_sonde <- Master_2024_output %>% dplyr::filter(`Date Time` > '2024-06-10 00:00:00' & `Date Time` < '2024-11-13 23:00:00' )
#write.csv(Juvenile_sonde, "output/Juvenile_sonde_master.csv")
```
