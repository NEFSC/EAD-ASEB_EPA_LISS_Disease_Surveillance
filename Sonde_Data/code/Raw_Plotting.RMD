...
scale_color_manual(values=c(FENC = "darksalmon",ASHC = "cornflowerblue", GOLD = "darkseagreen")) +
  ...
  theme(axis.text = element_text(size = 15), axis.title = element_text(size = 20), legend.text = element_text(size=18), 
        legend.title = element_text(size=20), title = element_text(size = 24), strip.text = element_text(size = 18), axis.text.x = element_text(angle = 20, vjust = .75, hjust = .5) )+
...
scale_color_manual(values=c("FENC" = "darksalmon",ASHC = "cornflowerblue", "GOLD" = "darkseagreen")) +
              ...
              scale_x_datetime(date_labels= "%b %Y", date_breaks = "3 month")+
  theme(axis.text = element_text(size = 15), axis.title = element_text(size = 20), legend.text = element_text(size=18), 
        legend.title = element_text(size=20), title = element_text(size = 20), strip.text = element_text(size = 18), axis.text.x = element_text(angle = 20, vjust = .75, hjust = .5))

All_salinity.graph

#combining the two graphs salinity and temp
all_salvtemp<-ggarrange(All_salinity.graph,All_temp.graph, ncol = 1)
all_salvtemp


pdf(paste0(path = "output/raw_plots/salinity_temp_all.pdf"), height = 8.5, width = 11)
print(all_salvtemp)
