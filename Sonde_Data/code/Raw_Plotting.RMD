...
```
#removing outlier's from GOLD on dates of calibration/sonde deployment
```{r}
#2024-07-22 10:00:00 reads the all time low pH reading of 6.994071 , measurements for this day jump from 7.726598 at 09:00:00 -> 6.994071 at 10:00:00 -> 7.629097 at 11:00:00 ; next date.time to remove is 2024-04-22 15:00:00 , reading the highest pH of 9.400000 , measurements for this day jump from the 9.4 to 8.205 after one hour.

#2024-07-22 10:46:00 pH of 6.164764 #sonde deployed
#2024-04-22 15:14:00 pH of 10.60 # Field notes say sonde was deployed at 11:30am this day, however the first pH measurement recorded was at 3:15pm ; other parameters for this date.time are also out of range / innaccurate 

target_time_2024_07GOLD <- as.POSIXct("2024-07-22 10:46:00")
Master_table <- Master_table %>% filter(Date.Time != target_time_2024_07GOLD)

target_time_2024_04GOLD <- as.POSIXct("2024-04-22 15:14:00")
Master_table <- Master_table %>% filter(Date.Time != target_time_2024_04GOLD)
