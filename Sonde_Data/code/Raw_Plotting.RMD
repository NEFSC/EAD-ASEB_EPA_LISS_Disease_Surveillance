...
Last updated 08/6/2026 by M.Kachmar
...
pdf(paste0(path = "output/raw_plots/QAQC_plots","/pH_QAQC.pdf"), height = 6, width = 11) 
print(QAQC_plot)
dev.off()
...
pdf(paste0(path = "output/raw_plots/LISS_proposal_plots","/CT_pH_2026.pdf"), height = 6, width = 11) #Change the name of the file here based on the time frame of the graph
...
pdf(paste0(path = "output/raw_plots/LISS_proposal_plots","/CT_pH_ALL.pdf"), height = 6, width = 11)
#ggarrange(CT_pH_2025, CT_pH_callout_2025, ncol = 2, widths = c(2, 1))
print(CT_pH_ALL)
dev.off()
...
pdf(paste0(path = "output/raw_plots/LISS_proposal_plots/CT_Salinity_2026.pdf"), height = 6, width = 11) #Change the name of the file here based on the time frame of the graph
...
pdf(paste0(path ="output/raw_plots/LISS_proposal_plots/CT_Temperature_2026.pdf"), height = 6, width = 11) #Change the name of the file here based on the time frame of the graph
...
#CT_DO_callout_2025
pdf(paste0(path = "output/raw_plots/LISS_proposal_plots/CT_DO_2026.pdf"), height = 6, width = 11)
...
pdf(paste0(path = "output/raw_plots/Report_plots/ASHC_pH_2026.pdf"), height = 7, width = 14)
print(ASHC_pH_plot)
dev.off()
...
pdf(paste0(path = "output/raw_plots/Report_plots/ASHC_Salinity_2026.pdf"), height = 7, width = 14)
...
pdf(paste0(path = "output/raw_plots/Report_plots/ASHC_Temperature_2026.pdf"), height = 7, width = 14)
...
ASHC_DO_plot <- ASHC_DO %>% na.omit() %>%
             ...
             ggplot(aes(x=`Date Time`, 
              ...
              labs(x = "Time", y = "DO Concentration (mg/L)") +
              theme_classic() +
#pdf(paste0(path = "output/raw_plots/Report_plots/ASHC_DO_2026.pdf"), height = 7, width = 14)
print(ASHC_DO_plot)
...
pdf(paste0(path = "output/raw_plots/Report_plots/ASHC_CHLA_2026.pdf"), height = 7, width = 14)
...
ASHC_DAILY_DO_plot
pdf(paste0(path = "output/raw_plots/Report_plots/ASHC_daily_DO_2026.pdf"), height = 7, width = 14) # update file name to reflect date range
...
pdf(paste0(path = "output/raw_plots/Report_plots/FENC_pH_2026.pdf"), height = 7, width = 14)
print(FENC_pH_plot)
dev.off()
...
pdf(paste0(path = "output/raw_plots/Report_plots/FENC_Salinity_2026.pdf"), height = 7, width = 14)
...
pdf(paste0(path = "output/raw_plots/Report_plots/FENC_Temperature_2026.pdf"), height = 7, width = 14)
...
pdf(paste0(path = "output/raw_plots/Report_plots/FENC_DO_2026.pdf"), height = 7, width = 14)
print(FENC_DO_plot)
...
pdf(paste0(path = "output/raw_plots/Report_plots/FENC_CHLA_2026.pdf"), height = 7, width = 14)
...
pdf(paste0(path="output/raw_plots/Report_plots/FENC_daily_DO_2026.pdf"), height = 7, width = 14)
...
pdf(paste0(path="output/raw_plots/Report_plots/GOLD_pH_2026.pdf"), height = 7, width = 14)
print(GOLD_pH_plot)
dev.off()
...
pdf(paste0(path="output/raw_plots/Report_plots/GOLD_pH.pdf"), height = 7, width = 14)
print(GOLD_pH)
dev.off()
...
pdf(paste0(path="output/raw_plots/Report_plots/GOLD_Salinity_2026.pdf"), height = 7, width = 14)
...
pdf(paste0(path="output/raw_plots/Report_plots/GOLD_Temperature_2026.pdf"), height = 7, width = 14)
...
GOLD_DO_plot
pdf(paste0(path="output/raw_plots/Report_plots/GOLD_DO_2026.pdf"), height = 7, width = 14)
print(GOLD_DO_plot)
dev.off()
...
pdf(paste0(path="output/raw_plots/Report_plots/GOLD_CHLA_2026.pdf"), height = 7, width = 14)
...
pdf(paste0(path="/raw_plots/Report_plots/GOLD_daily_DO_2026.pdf"), height = 7, width = 14)
...
#pdf(paste0(path = "output/raw_plots/salinity_temp_all.pdf"), height = 7, width = 12)
print(all_salvtemp)
...
#pdf(paste0(path = "output/raw_plots/Temperature_Salinity_all.pdf"), height = 7, width = 14)
