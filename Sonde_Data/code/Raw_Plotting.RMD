...
Last updated 10/24/24 by M.Kachmar
...
FENC_DO_2024 <- FENC_DO %>% na.omit() %>%
             ...
             ggplot(aes(x=`Date Time`, 
              ...
              labs(x = "Time", y = "DO Concentration (mg/L)") +
              theme_classic() +
              theme(legend.position = "none", axis.text= element_text(size= 15))+scale_x_datetime(breaks="1 month", date_labels = "%B")+geom_hline(yintercept = 5, color = "red", linetype = "solid", size = 1)
...
FENC_CHLA_2024 <- FENC_CHLA %>% na.omit() %>%
             ...
             ggplot(aes(x=`Date Time`, 
              ...
              labs(x = "Time", y = "Chlorophyll-a (RFU)") +
              theme_classic() +
              theme(legend.position = "none", axis.text= element_text(size= 15))+scale_x_datetime(breaks="1 month", date_labels = "%B")+ylim(0,100)
