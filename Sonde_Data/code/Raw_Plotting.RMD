...
FENC_Temp_Sonde <- Master_table_LONG %>% filter(Site == "FENC")
ASHC_Temp_Sonde <- Master_table_LONG %>% filter(Site == "ASHC")
GOLD_Temp_Sonde <- Master_table_LONG %>% filter(Site == "GOLD")
