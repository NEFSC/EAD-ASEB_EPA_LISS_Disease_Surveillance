...
Last updated 01/16/2026 by M.Kachmar
...
CT_pH_2025 <- CT_pH %>% na.omit() %>%
             dplyr::filter(Date.Time > '2025-01-01 00:00:00' & Date.Time < '2026-01-31 23:59:00' ) %>% # change date range needed here
             dplyr::mutate(Site = case_when(Site == 'ASHC' ~ 'Ash Creek', .default = 'Fence Creek')) %>% 
             ggplot(aes(x=Date.Time, 
                       y=mean, # the mean values
                       group=Site)) + # call the new mean
...
ASHC_pH_2025 <- ASHC_pH %>% na.omit() %>%
             dplyr::filter(Date.Time > '2025-01-01 00:01:00' & Date.Time < '2026-01-31 23:59:00' ) %>%  # change date range needed here
             dplyr::mutate(Site = case_when(Site == 'ASHC' ~ 'Ash Creek', .default = 'Fence Creek')) %>% 
             ggplot(aes(x=Date.Time, 
                       y=mean, # the mean values
                       group=Site)) + # call the new mean
...
ASHC_DO_2025 <- ASHC_DO %>% na.omit() %>%
             dplyr::filter(Date.Time > '2025-01-01 00:01:00' & Date.Time < '2026-01-31 12:59:00' ) %>% # change date range needed here
             dplyr::mutate(Site = case_when(Site == 'ASHC' ~ 'Ash Creek', .default = 'Fence Creek')) %>% 
             ggplot(aes(x=Date.Time, 
                       y=mean, # the mean values
                       group=Site)) + # call the new mean
...
ASHC_DAILY_DO_2025 <- ASHC_DO_avg %>% 
   dplyr::filter(date > '2025-01-01 00:00:00' & date < '2026-01-31 00:00:00' ) %>%
    ggplot(aes(x= date, 
                       y=Daily_mean, # the mean values
                       group=Site)) + # call the new mean
              geom_line(aes(group = factor(Site), # lines for site
...
ASHC_DAILY_DO_2025
pdf(paste0(path = "output/raw_plots/Report_plots/ASHC_daily_DO_2025.pdf"), height = 7, width = 14)
print(ASHC_DAILY_DO_2025)
...
FENC_pH_2025 <- FENC_pH %>% na.omit() %>%
             dplyr::filter(Date.Time > '2025-01-01 00:01:00' & Date.Time < '2026-01-31 23:59:00' ) %>% 
             dplyr::mutate(Site = case_when(Site == 'FENC' ~ 'Fence Creek', .default = 'Ash Creek')) %>% 
             ggplot(aes(x=Date.Time, 
                       y=mean, # the mean values
                       group=Site)) + # call the new mean
              ...
              labs(x = "Time", y = "pH") +
              theme_classic() +
              theme(legend.position = "none", axis.text= element_text(size= 15))+scale_x_datetime(breaks="1 month", date_labels = "%B") + geom_hline(yintercept = 7.5, color = "red", linetype = "solid", size = 1)
...
FENC_Salinity_2025 <- FENC_Salinity %>% na.omit() %>%
             ...
             ggplot(aes(x=Date.Time, 
              ...
              theme_classic() +
              theme(legend.position = "none", axis.text= element_text(size= 15))+
              scale_y_continuous(breaks = seq(0,30, by = 2))+scale_x_datetime(breaks="1 month", date_labels = "%B") + geom_hline(yintercept = 10, color = "red", linetype = "solid", size = 1)
...
FENC_Temperature_2025 <-FENC_Temperature %>% na.omit() %>%
             ...
             ggplot(aes(x=Date.Time, 
              ...
              labs(x = "Time", y = "Temperature (Celcius)") +
              theme_classic() +
              theme(legend.position = "none", axis.text= element_text(size= 15))+scale_x_datetime(breaks="1 month", date_labels = "%B")  + geom_hline(yintercept = 20, color = "red", linetype = "solid", size = 1)
...
FENC_DO_2025 <- FENC_DO %>% na.omit() %>%
             dplyr::filter(Date.Time > '2025-01-01 00:01:00' & Date.Time < '2026-01-01 23:59:00' ) %>% 
             dplyr::mutate(Site = case_when(Site == 'FENC' ~ 'Fence Creek', .default = 'Fence Creek')) %>% 
             ggplot(aes(x=Date.Time, 
                       y=mean, # the mean values
                       group=Site)) + # call the new mean
              ...
              labs(x = "Time", y = "DO Concentration (mg/L)") +
              theme_classic() +
              theme(legend.position = "none", axis.text= element_text(size= 15))+scale_x_datetime(breaks="1 month", date_labels = "%B") + geom_hline(yintercept = 5, color = "red", linetype = "solid", size = 1)+geom_hline(yintercept = 3, color = "blue", linetype = "solid", size = 1)
...
FENC_DAILY_DO_2025 <- FENC_DO_avg %>% dplyr::filter(date > '2025-01-01 00:01:00' & date < '2026-01-01 23:59:00' ) %>% 
...
pdf(paste0(path="output/raw_plots/Report_plots/FENC_daily_DO_2025.pdf"), height = 7, width = 14)
print(FENC_DAILY_DO_2025)
...
GOLD_pH_ALL <- GOLD_pH %>% na.omit() %>%
             dplyr::filter(Date.Time > '2023-04-01 00:01:00' & Date.Time < '2025-12-31 23:59:00' ) %>% # change date range needed here
             dplyr::mutate(Site = case_when(Site == 'GOLD' ~ 'Gold Star', .default = 'Fence Creek')) %>% 
             ggplot(aes(x=Date.Time, 
                       y=mean, # the mean values
                       group=Site)) + # call the new mean
