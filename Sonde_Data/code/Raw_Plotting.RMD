...
Sonde_monthly_means_wide <- Sonde_monthly_means_CT %>% pivot_wider(names_from = variable, values_from = c("mean", "sd", "se"))
write.csv(Sonde_monthly_means_CT, "output/Sonde_monthly_means_CT_wide.csv")
