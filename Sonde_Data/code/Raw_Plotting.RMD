...
Updated some of the code to remove the bulkiness of this file. We have alot of repetative code chunks for graphs that can be removed and we can simply update the date range we want to see and the file name when were running the code (i.e. If we are QAQC'ing 2026 data, change the file to "..._2026")
