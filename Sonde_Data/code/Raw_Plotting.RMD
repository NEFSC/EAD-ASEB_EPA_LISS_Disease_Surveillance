...
ASHC_pH_2024 <- ASHC_pH %>% na.omit() %>%
             ...
             ggplot(aes(x=`Date Time`, 
              ...
              labs(x = "Time", y = "pH") +
              theme_classic() +
              theme(legend.position = "none", axis.text= element_text(size= 15))+geom_hline(yintercept = 7.5, color = "red", linetype = "solid", size = 1)
...
ASHC_Salinity_2023 <- ASHC_Salinity %>% na.omit() %>%
             ...
             ggplot(aes(x=`Date Time`, 
              ...
              labs(x = "Time", y = "Salinity") +
              theme_classic() +
              theme(legend.position = "none", axis.text= element_text(size= 15))+geom_hline(yintercept = 10, color = "red", linetype = "solid", size = 1)
...
ASHC_Temperature_2024 <-ASHC_Temperature %>% na.omit() %>%
             ...
             ggplot(aes(x=`Date Time`, 
              ...
              labs(x = "Time", y = "Temperature (Celcius)") +
              theme_classic() +
              theme(legend.position = "none", axis.text= element_text(size= 15))+geom_hline(yintercept = 20, color = "red", linetype = "solid", size = 1)
...
ASHC_DO_2024 <- ASHC_DO %>% na.omit() %>%
             ...
             ggplot(aes(x=`Date Time`, 
              ...
              labs(x = "Time", y = "DO Concentration (mg/L)") +
              theme_classic() +
              theme(legend.position = "none", axis.text= element_text(size= 15))+geom_hline(yintercept = 5, color = "red", linetype = "solid", size = 1)
...
GOLD_pH_2024 <- GOLD_pH %>% na.omit() %>%
             ...
             ggplot(aes(x=`Date Time`, 
              ...
              theme_classic() +
              theme(legend.position = "none", axis.text= element_text(size= 15))+  
  geom_hline(yintercept = 7.5, color = "red", linetype = "solid", size = 1) +ylim(6,9)
...
GOLD_Salinity_2024 <- GOLD_Salinity %>% na.omit() %>%
             ...
             ggplot(aes(x=`Date Time`, 
              ...
              theme(legend.position = "none", axis.text= element_text(size= 15))+
              scale_y_continuous(breaks = seq(0,30, by = 2))+  
  geom_hline(yintercept = 12, color = "red", linetype = "solid", size = 1)+ylim(20,30)
