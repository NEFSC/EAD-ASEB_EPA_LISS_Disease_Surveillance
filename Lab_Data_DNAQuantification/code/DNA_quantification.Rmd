...
#Percentage of standard error >10 for qubit
high_se <- qubit_summary %>% filter(se > 10) %>% nrow() #creates number of rows that have sd # >10
high_se_list <- qubit_summary %>% filter(se > 10) #creates list of which samples have high sd
percentage_highse <- (high_se/nrow(qubit_summary)) * 100 # determining percentage of samples have high standard deviation
percentage_highse #outputs percentage
```
