...
- We need to combine june for both fence creek and ash creek to create a t0. Best way to do this?
- Still working on calculating growth rate - not finding good examples to kick off. also need to combine t0 first
...
# we want June to be t0 for both sites. We need to combine ASHC & FENC. Is this the best way to do this? 
...
ASHC<- data_all %>% filter(Site %in% c("ASHC", "Initial"))
FENC<- data_all %>% filter(Site %in% c("FENC", "Initial"))
...
#Calculating growth rate. We can use GR or SPG to calculate. Since we want to combine T0 from fence and ash creek GR may be more appropriate. 
