...
---
Last updated 11/26/24 by M.Kachmar
...
glm_ph_jg <- glmmTMB(Shell_length ~ mean * Site +  (1 | Bag_number), data = pH_merged)
Anova(glm_ph_jg)
summary(glm_ph_jg)
...
file.create("Juvenile_growth.Rmd")
rmarkdown::render("Juvenile_growth.Rmd", output_format = "pdf_document")
```
