...
summary(gam_temp)
#Mean values have a slight negative trend (decreasing over time) but isnot statistically significant across months, no sign diff between sites
...
gam_CHLA_gr <- gam(monthly_growth_rate ~ s(mean)  , data = CHLA_gr) #CHLA significant
summary(gam_CHLA_gr)
