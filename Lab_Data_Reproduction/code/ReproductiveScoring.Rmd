...
bcs_1 <- bcs_all %>% filter(!is.na(date_collected)) %>% select( lab_id, site, condition)

repro_1 <- data_all%>% rename(lab_id = Sample_ID) %>% select(lab_id, Sex_final, Stage_final)
