...
all_repro_graph<-ggplot(all_repro, aes(x=Sex_final, fill=Stage_final))+
  labs(title = "Gametogenesis Scores in 2024 of LIS Study Sites", x="Sex Ratio", y="Reproductive Stage Counts", fill="Reproductive Stages")+
...
#scale_fill_wa_d(wacolors$sound_sunset, reverse = TRUE)+
  ...
  scale_fill_manual(values = c("#FFE66C","#EBCC5C","#DE9F71","#B490BF","#A26D7C","#533369","#001E36","gray"))+
    scale_x_discrete(labels = c("ND"="Unk", "Female" = "\u2640", "Male" = "\u2642", "Hermaphrodite"=" \u26a5"))+
