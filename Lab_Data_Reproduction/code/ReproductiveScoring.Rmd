...
#multiple lines within one month becasue we will need to separate by years, once we have more 2024 reproductive data
...
ggplot(ASHC_repro.bcs, aes(x=factor(month),y=Percentage, fill = variable))+
