...
---
Last updated 11/25/24 by K. Lenderman
  - Accuracy 80.4%
...
ggplot(data=df_wp_summary, aes(x=month, y=Weighted_prevalence, color=site)) +
  ...
  theme(axis.text=element_text(size=12)) + facet_wrap(~ year, scales = "fixed", ncol=1,)+scale_x_continuous(breaks = c(3,4,5,6,7,8,9,10,11))
