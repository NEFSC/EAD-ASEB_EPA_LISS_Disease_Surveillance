...
###### Preliminary Statistics on ALL RFTM data ######
  ...
  #kruskal- Wallis test - non-parameteric test used to compare three or more independent groups to see if there distrubutions     differ , alternative to one way ANOVA, suitable for ordinal or continous data
